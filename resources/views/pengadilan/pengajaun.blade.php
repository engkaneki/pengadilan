...
@section('content')
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" class="form-control" name="nik"
                                                                    id="nik" value="{{ $d->nik }}" readonly>
                                                                <input type="number" class="form-control" name="id"
                                                                    id="id" value="{{ $d->id }}" readonly
                                                                    hidden="true">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
    ...
    <div class="modal fade " id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg modal-dialog-centered">
            <form class="modal-content" method="POST" action="{{ url('pengajuan/simpan') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            is-invalid
                        @enderror"
                            name="nama" id="nama" placeholder="Masukkan Nama Pelapor" value="{{ old('nama') }}">
                        @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
